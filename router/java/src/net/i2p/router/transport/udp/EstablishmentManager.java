...
class EstablishmentManager {
    ...
    private void handleCompletelyEstablished(InboundEstablishState state) {
        ...
        if (version == 1) {
            ...
            RouterInfo info = _context.netDb(null).lookupRouterInfoLocally(remote.calculateHash());
            if (info != null) {
...
****/
                ...
                if (h != null) {
                    ...
                    switch (istate) {
                        ...
                        case INTRO_STATE_HAS_RI:
                            bob = _context.netDb(null).lookupRouterInfoLocally(h);
                            if (bob != null)
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (h != null) {
                    ...
                    if (istate == INTRO_STATE_INIT) {
                        ...
                        state2.setIntroState(h, istate);
                        // TODO on success job
                        _context.netDb(null).lookupRouterInfo(h, null, null, 10*1000);
                        sent = true;
                    }
                }
            }
    ...
    void receiveRelayResponse(PeerState2 bob, long nonce, int code, byte[] data) {
        ...
        RouterInfo bobRI = _context.netDb(null).lookupRouterInfoLocally(bobHash);
        RouterInfo charlieRI = _context.netDb(null).lookupRouterInfoLocally(charlieHash);
        Hash signer;
        ...
        RouterInfo signerRI = _context.netDb(null).lookupRouterInfoLocally(signer);
        if (signerRI != null) {
