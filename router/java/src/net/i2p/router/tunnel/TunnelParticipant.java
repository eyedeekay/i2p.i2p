...
class TunnelParticipant {
    ...
    private TunnelParticipant(RouterContext ctx, HopConfig config, HopProcessor processor, InboundEndpointProcessor inEndProc) {
        ...
        if ( (_config != null) && (_config.getSendTo() != null) ) {
            _nextHopCache = _context.netDb(null).lookupRouterInfoLocally(_config.getSendTo());
            if (_nextHopCache == null)
                _context.netDb(null).lookupRouterInfo(_config.getSendTo(), new Found(_context), null, LONG_MAX_LOOKUP_TIME);
        }
    ...
    public void dispatch(TunnelDataMessage msg, Hash recvFrom) {
        ...
        if ( (_config != null) && (_config.getSendTo() != null) ) {
            ...
            if (ri == null)
                ri = _context.netDb(null).lookupRouterInfoLocally(_config.getSendTo());
            if (ri != null) {
                ...
                if (_log.shouldLog(Log.WARN))
                    _log.warn("Lookup the nextHop (" + _config.getSendTo()
                              + " for " + msg);
                _context.netDb(null).lookupRouterInfo(_config.getSendTo(), new SendJob(_context, msg),
    ...
    private class SendJob extends JobImpl {
        ...
        public void runJob() {
            if (_nextHopCache != null) {
                ...
                RouterInfo ri = _context.netDb(null).lookupRouterInfoLocally(_config.getSendTo());
                int stat;
                if (ri != null) {
                    _nextHopCache = ri;
