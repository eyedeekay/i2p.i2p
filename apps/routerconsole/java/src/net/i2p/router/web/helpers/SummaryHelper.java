...
**/
    ...
    public boolean allowReseed() {
        return _context.netDb(null).isInitialized() &&
               (_context.netDb(null).getKnownRouters() < ReseedChecker.MINIMUM) ||
    ...
    public int getAllPeers() { return Math.max(_context.netDb(null).getKnownRouters() - 1, 0); }
...
*/
        ...
        switch (status) {
            ...
            case IPV4_FIREWALLED_IPV6_UNKNOWN:
                if (((FloodfillNetworkDatabaseFacade)_context.netDb(null)).floodfillEnabled())
    ...
    public String getDestinations() {
        ...
        if (!clients.isEmpty()) {
            ...
            for (Destination client : clients) {
                ...
                buf.append("</a></b></td>\n");
                LeaseSet ls = _context.netDb(null).lookupLeaseSetLocally(h);
    ...
    public String getFirewallAndReseedStatus() {
        ...
        ReseedChecker checker = _context.netDb(null).reseedChecker();
